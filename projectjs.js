...
function asepriteproject() {
    document.getElementById("projectshow").innerHTML = '<h3 class="projecttitle">Aseprite Project</h3><br><b class="headerproject">Dimension Break character design</b><br><img src="otherproject/unity/Aseprite_1.png" alt="" class="projectimg imgcenter">';
    document.getElementById("projectshow").innerHTML += '<p class="projectdescription">"Character design สำหรับเกม Dimension Break"</p>'
    document.getElementById("projectshow").innerHTML += '<p class="centertxt">Dimension Break เป็นเกม 2D Action Side Scrolling ที่จะให้ผู้เ"ล่นได้สู้กับ Monster ต่าง ๆ เพื่อนำพื้นที่ที่อยู่อาศัยของมนุษย์กลับคืนมา</p><br><hr>'
...
function blenderproject() {
    ...
    document.getElementById("projectshow").innerHTML += '<p class="centertxt">Battle Suite เป็นเกม 3D Thirdperson shooter ที่จะให้ผู้เล่นได้ขับหุ่นยนตร์ในการปกป้องเมืองต่าง ๆ</p><br><hr>'
